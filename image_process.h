...
void opening(cv::Mat &m, double percentage = 38.2, bool erodeEdge = true);	//with specified percentage of pixels to be eroded before dilation
...
void closing(cv::Mat &m, double percentage = 38.2, bool erodeEdge = false);	//with specified percentage of pixels to be dilated before erosion
