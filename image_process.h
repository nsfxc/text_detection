...
void opening8(cv::Mat &m, int layer, bool erodeEdge = true);					//with specified layer of pixels to be eroded before dilation
void opening8(cv::Mat &m, double percentage = 61.8, bool erodeEdge = true);	//with specified percentage of pixels to be eroded before dilation

// in place closing process with the nearest 8 neighbours 
void closing8(cv::Mat &m, int layer, bool erodeEdge = false);				//with specified layer of pixels to be dilated before erosion
void closing8(cv::Mat &m, double percentage = 61.8, bool erodeEdge = false);	//with specified percentage of pixels to be dilated before erosion

// in place opening process with the nearest 4 neighbours 
void opening4(cv::Mat &m, int layer, bool erodeEdge = true);					//with specified layer of pixels to be eroded before dilation
void opening4(cv::Mat &m, double percentage = 38.2, bool erodeEdge = true);	//with specified percentage of pixels to be eroded before dilation

// in place closing process with the nearest 4 neighbours 
void closing4(cv::Mat &m, int layer, bool erodeEdge = false);				//with specified layer of pixels to be dilated before erosion
void closing4(cv::Mat &m, double percentage = 38.2, bool erodeEdge = false);	//with specified percentage of pixels to be dilated before erosion
